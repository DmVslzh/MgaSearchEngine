...
import ru.search.mga.lemmas.LemmasListCreator;
import org.jsoup.Jsoup;
import org.jsoup.safety.Safelist;

import java.util.*;

import static ru.search.mga.relevance.Relevancer.getPagesRelRelevance;
...
//        String snippet =  getSnippet(content,                 searchRequest);
    ...
    public static List<PageInfo> getPagesFullRelevanceInfo (String searchRequest, int borderValue) {
        ...
        HashMap<Integer,Float> pagesRelRelevance = Relevancer.getPagesRelRelevance(searchRequest, borderValue);
    ...
    public static List<PageInfo> getPagesFullRelevanceInfo (String searchRequest, int borderValue, Integer siteId,
        ...
        List<PageInfo> pageInfoList = new ArrayList<>();
        HashMap<Integer,Float> pagesRelRelevance = Relevancer.getPagesRelRelevance(searchRequest, borderValue, siteId);
